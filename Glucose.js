...
const cells = [
  { id: 1, heading: 'Blood Glucose', unit: 'mg/dl' },
  { id: 2, heading: 'Curve'}
];
  ...
  return (
    <View style={styles.container}>
      <View style={styles.rectangle}>
        ...
        <Text style={styles.rectangleText}>Blood{"\n"}Glucose</Text>
     </View>
      <View style={styles.grid}>
        {cells.map((cell) => {
            ...
            switch (id) {
                case 1:
                return 99; // Value for ID 1
                case 2:
                return (
                                    <Image
                                      source={require('./assets/graph.png')} // Replace with your curve image path
                                      style={styles.curveImage}
                                    />
                                  ); // Display curve image for ID 2
      ...
      <View style={styles.bottomBar}>
        <TouchableOpacity style={styles.button} onPress={() => handleButtonPress('A')}>
          <Text style={styles.buttonText}>Profile</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => handleButtonPress('B')}>
...
const styles = StyleSheet.create({
  ...
  curveImage: {
    width: '80%',  // Adjust based on image size and design
    height: 120,   // Adjust based on image size and design
    resizeMode: 'contain',
  },
  cell: {
    width: '90%',
