    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.profileHeader}>
          ...
          <Text style={styles.userId}>User ID: {userData.email.split('@')[0]}</Text>
...
const styles = StyleSheet.create({
  ...
  header: {
    width: '100%',
    height: Platform.OS === 'ios' ? responsiveSize(90) : responsiveSize(70),
    backgroundColor: globalStyles.primaryColor.color,
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
    paddingHorizontal: responsiveSize(15),
    paddingTop: Platform.OS === 'ios' ? responsiveSize(40) : responsiveSize(10),
