...
const cells = [
  { id: 1, heading: 'Flowrate', unit: 'ml/h' },
  { id: 2, heading: 'Volume', unit: 'ml'}
];
  ...
  return (
    <View style={styles.container}>
      <View style={styles.rectangle}>
        ...
        <Text style={styles.rectangleText}>IV InfuzaMed</Text>
     </View>
      <View style={styles.grid}>
        {cells.map((cell) => {
            ...
            switch (id) {
                case 1:
                return 120; // Value for ID 1
                case 2:
                return 80;  // Value for ID 2
                case 3:
                return 72;  // Value for ID 3
                default:
